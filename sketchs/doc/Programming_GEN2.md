...
acting as the NTSC group selector. Hardware reference: [`GEN2_RELEASE.md`](../../doc/GEN2_RELEASE.md).
...
`fill_block` does a read-modify-write: `byte |= mask1`, and if `mask2 ≠ 0`, `byte+1 |= mask2`. See `sketchs/gen2/game_maze/HGR_Maze.asm`.
