...
| [`_template_gen2c/`](../gen2/_template_gen2c/) | Copy-paste starter project for GEN2 colour graphics |
...
| [`dev/lib/gen2c/README.md`](../../dev/lib/gen2c/README.md) | Full `gen2c` API reference + gotchas |
| [`GEN2_RELEASE.md`](../../doc/GEN2_RELEASE.md) | Card hardware, soft-switches, beam-race renderer |

---

## 1. GEN2 HGR colour (`gen2c`)

`#include "gen2.h"` — 280×192 HIRES. Full API + gotchas: [lib/gen2c/README.md](../../dev/lib/gen2c/README.md).
