...
OUTDO:	ora	#$80    ; Set hi bit
	jsr	OUTVEC	; GEN2: dispatch via CSW (GEN2 text console or Apple-1 ECHO)
	and	#$7F	; clear hi bit
	rts
; CSW (Apple II-style char-out vector) is set by GEN2_BOOT to the Apple-1 ECHO
; ($FFEF) by default; the PRINT wrapper points it at the GEN2 text console.
OUTVEC:	jmp	(CSW)
