...
; ----------------------------------------------------------------------------
	; GEN2: HIMEM is FIXED at $2000 instead of probing RAM upward. On the
	; 48 KB GEN2 machine the probe would walk straight through the HGR
	; framebuffer ($2000-$3FFF) AND this interpreter image (both real RAM)
	; and hand BASIC's string/variable space addresses that clobber them.
	; Program + variables + strings therefore live in $0800-$1FFF (6 KB),
	; safely below the HGR framebuffer.
