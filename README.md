...
**Core machine** — Authentic 40×24 display (`charmap.rom` bitmap, three CRT phosphors, scanlines, glow), cycle-accurate **6502** (all official opcodes, ~1.022727 MHz / 2× / MAX), paste-code, step debugger, live memory editor + visual map, **14 one-click presets** from *Bare Apple-1 (July 1976)* to *POM1 Multiplexing Fantasy (2026)*.
...
| 6 | **P-LAB A1-SID Sound Card** | 8 KB | — | A1-SID (address selectable in Settings: $C800 or A1-AUDIO SE $CC00) |
| 7 | **P-LAB Apple-1 with TMS9918 + CodeTank** | 8 KB | — | TMS9918, CodeTank |
| 8 | **P-LAB I/O Board & RTC** | 8 KB | — | I/O & RTC |
| 9 | **P-LAB Wi-Fi Modem BBS** | 8 KB | — | Wi-Fi Modem |
| 10 | **P-LAB Juke-Box** | 8 KB | — | Juke-Box (no ACI) |
| 11 | **P-LAB Multiplexing Fantasy** | 64 KB | Applesoft Lite | microSD, A1-SID, TMS9918 + CodeTank, I/O & RTC, Wi-Fi, Terminal |
...
Plug the CodeTank daughterboard (preset 7 or *Hardware → CodeTank*), open *File → P-LAB CodeTank Library*, pick a `.rom`, choose a jumper. **5 cartridges shipped**, all rebuilt from source via `python3 tools/build_codetank_rom.py`:
...
- **POM1 Bench** — an in-app cc65/ca65 sketch editor: write 6502 asm or C, assemble/compile, and run on the emulator without leaving the window. **New sketch** picks a **Language** (Assembly · ca65/ld65, or C · cc65/cl65) × **Machine**, and drops in a matching "HELLO WORLD" starter:
  ...
  - **P-LAB Graphic Card (TMS9918)** — Graphics I text (credit: Claudio Parmigiani's card).
