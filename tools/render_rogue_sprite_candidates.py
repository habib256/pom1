...
COLUMNS = [
    ("DOOR", "TILE_DOOR (id 12, group 1, dk-yellow)", 10, 1, [
        ("bldg_door_wood_pat",    "current (was bldg_battlement_pat)"),
        ("bldg_door_pat",         "metal door"),
        ("bldg_door_locked_pat",  "locked door"),
        ("bldg_window_pat",       "window"),
        ("bldg_window_grate_pat", "window grate"),
        ("trap_grate_pat",        "grate"),
        ("expl_lock_pat",         "lock"),
    ]),
    ("STAIRS_DOWN", "TILE_STAIRS_DOWN (id 8, group 1, dk-yellow)", 10, 1, [
        ...
        ("magic_portal_pat",    "portal"),
        ("magic_vortex_pat",    "vortex"),
        ("trap_pit_pat",        "pit trap"),
        ("sym_spiral_pat",      "spiral"),
        ("sym_x_pat",           "X mark"),
        ("magic_runestone_pat", "runestone"),
    ]),
    ("STAIRS_UP", "TILE_STAIRS_UP (id 16, group 2, lt-yellow)", 11, 1, [
        ...
        ("magic_ankh_pat",     "ankh"),
        ("magic_sun_pat",      "sun"),
        ("sym_arrow_up_pat",   "arrow up"),
        ("sym_sparkle_pat",    "sparkle"),
        ("sym_star_pat",       "star"),
    ]),
]
