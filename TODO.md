...
**Reste** : **vérif navigateur** (ouvrir `POM1.html`, tester un sketch asm + C — non testable headless cette session ; mais glue Node-vérifiée byte-identique des deux côtés + les deux builds compilent). TMS-C non Node-vérifié individuellement (même mécanisme buildC que GEN2-C).
