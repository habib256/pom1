...
- [ ] **Documenter la règle portage jeux** `[S · solid]` — note `doc/GEN2_RELEASE.md` : patch `$C05x`→`$C25x`, conserver `$C030-$C03F` (SPEAKER Apple II) intacts pour les effets sonores via TAPE OUT de l'ACI (Q7), retirer les autres accès `$C0xx` des ports Apple II, dual-monitor (texte `$D012` + HGR GEN2).
