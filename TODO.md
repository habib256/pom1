...
> **WASM cc65 — abandonné (2026-06-14).** Pas de toolchain DEV dans le build web : compiler cc65 (`ca65`/`ld65`/`cl65`) en WASM est un chantier `[L]` disproportionné pour un émulateur grand public. Le Bench reste **desktop-only** ; le web garde l'émulateur + le Serial Monitor (*Telemetry Side Channel*).
