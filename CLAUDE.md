...
- `$D012` (DSP) — write triggers display callback + TerminalCard sniffer + PR-40 sniffer. Read returns bit 7 = 0 (ready) after terminal-speed delay, else bit 7 = 1 (busy); counter clamped ≥ 0. PR-40 busy OR-merged on read when switch mode ≠ Off.
