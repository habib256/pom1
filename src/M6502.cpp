...
// opcode tables; abs,X NOPs (1C/3C/5C/7C/DC/FC) add +1 on a page cross in Unoff3.
constexpr uint8_t kIllegalTotalCycles[256] = {
    ...
    0x00, 0x00, 0x02, 0x08, 0x03, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x06,
    0x00, 0x00, 0x02, 0x08, 0x04, 0x00, 0x00, 0x06, 0x00, 0x00, 0x02, 0x07, 0x04, 0x00, 0x00, 0x07,
    0x02, 0x00, 0x02, 0x08, 0x00, 0x00, 0x00, 0x05, 0x00, 0x02, 0x00, 0x02, 0x00, 0x00, 0x00, 0x06,
    0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x05, 0x05, 0x00, 0x05, 0x07,
    0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x06,
    0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x07,
...
bool isAbsXIllegalNop(uint8_t opcode)
{
    switch (opcode) {
...
{
    if (isAbsXIllegalNop(lastFetchedOpcode)) {
        uint16_t base = memory->memRead(programCounter++);
        base |= static_cast<uint16_t>(memory->memRead(programCounter++)) << 8;
        const uint16_t eff = static_cast<uint16_t>(base + xRegister);
        cycles = kIllegalTotalCycles[lastFetchedOpcode];
