...
Re-uses the level pack and core push logic from `dev/projects/apple1/game_sokoban/`
...
- `bbfont_subset.inc` (in `dev/lib/gen2/`) — HUD/title 8×8 font subset
- libs used: `dev/lib/apple1/`, `dev/lib/gen2/`, `dev/lib/games/sokoban/`
- linker config: `apple1_sok_hgr.cfg` (local to this project)
...
By hand:
    ...
    ca65 -I ../../../lib/apple1 -I ../../../lib/gen2 -I ../../../lib/games/sokoban HGR_Sokoban.asm
    ld65 -C apple1_sok_hgr.cfg HGR_Sokoban.o \
