...
; =============================================
; Assemble:
;   ca65 -o build/HGR_Connect4.o software/hgr/HGR_Connect4.asm
;   ld65 -C software/hgr/apple1_gen2.cfg -o build/HGR_Connect4.bin build/HGR_Connect4.o
;
; Load via File > Load Memory (HGR_Connect4.txt), E000R.
