...
def main() -> int:
    ...
    emit_cl65(
        ...
        extra_sources=[
            ...
            # listing unused families wastes ROM/RAM. Here: CORE + sprites
            # (blit7) + geom (line/rect, which plot pixels via pixel) + pixel
            # + text (puts/puts8/putu_field, pulls rect). Dropped: lores.
            f"{GEN2C}/gen2_init.c",
