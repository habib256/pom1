...
hud_patterns:
        ; Shared 37 glyphs (TMS char 56..92) — see dev/lib/tms9918/font_hud8x8.inc
        .include "font_hud8x8.inc"
        ; char 93 '(' — Snake's slim paren (local override after the shared font)
