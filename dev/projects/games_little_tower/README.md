...
secret. Self-relocating: the source uses a literal `.org $0300`, so the
linker only writes the file header — code address is hard-coded.
...
- `LittleTower-1.0.asm` — main entry, `.org $0300` (self-located)
...
By hand:
    ...
    ld65 -C ../../cc65/apple1.cfg LittleTower-1.0.o -o ../../../software/games/LittleTower-1.0.bin
