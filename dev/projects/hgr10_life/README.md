# HGR10 Life — Conway's Game of Life (multi-pattern)
...
pattern, ESC to exit. Tenth entry in the HGR demo series.
...
## Build
    ...
    make                          # produces ../../../software/hgr/HGR10_Life.{bin,txt}

By hand:

    ca65 -I ../../lib/apple1 -I ../../lib/hgr HGR10_Life.asm
    ld65 -C ../../cc65/apple1_gen2.cfg HGR10_Life.o \
        -o ../../../software/hgr/HGR10_Life.bin
    python3 emit_HGR10_Life_txt.py
