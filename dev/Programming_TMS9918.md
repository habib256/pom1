...
| [`doc/TMS9918-SPRITE_INIT.md`](../doc/TMS9918-SPRITE_INIT.md) | Sprite initialisation reference |
| [`doc/CLI.md`](../doc/CLI.md) | `--silicon-strict` / `--no-silicon-strict` flags |
...
silicon. Toggle: Hardware menu or [`doc/CLI.md`](../doc/CLI.md)
...
Pre-patch extract from `dev/projects/tms9918/game_galaga/TMS_Galaga.asm`
("hidden" player slot):
...
`dev/projects/tms9918/game_galaga/TMS_Galaga.asm` is the first TMS9918
