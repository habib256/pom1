...
; ============================================================================
; Dual labels (pattern: gen2/gen2_init.asm): bare names for asm `.import`,
; _-prefixed for cc65 / C linkage (see demos/sprite_animals).
.export _fauna_rat_pat, _fauna_bat_pat, _fauna_centipede_pat, _fauna_spider_pat, _fauna_scorpion_pat
.export _fauna_snail_pat, _fauna_snake_pat, _fauna_wolf_pat, _fauna_lion_pat, _fauna_bear_pat
.export _fauna_drake_pat, _fauna_dragon_pat, _fauna_horse_pat
