...
7. **Sprite tearing**: never call `tms_set_sprite()` per frame on the
   ...
   VBlank. See `dev/_template_tms9918c/main.c`.
...
10. **Measure**: after every change, `ls -l software/<area>/*.bin` and
    track drift. Run `make` on `_template_gen2c` and `_template_tms9918c`
...
| [`TODO6502.md`](TODO6502.md) | Backlog of 6502-side work |
